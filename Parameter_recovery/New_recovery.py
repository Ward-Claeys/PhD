...
# -*- coding: utf-8 -*-
"""
Created on Mon May 11 15:21:25 2026

@author: wardclaeys

Parameter recovery that more closely resembles the actual behavioral task. 
"""
...
from New_recovery_Generate_dataset import generate_dataset
...
for i in range(parameter_values.shape[0]): 
    ...
    if __name__ == '__main__':
        ...
        filtered_filelist = [x for x in filtered_filelist if x != "New_Fitting_results.csv"]
    ...
    estimated_data.to_csv("New_Fitting_results.csv", columns = column_list, float_format ='%.3f')
