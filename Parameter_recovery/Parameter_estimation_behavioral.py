...
def likelihood(parameter_set, data):
    ...
    #Define the variables that are important for the likelihood estimation process
        ...
        ##########################################################################################
        #Here needs to be something that decides whether to include the trial in the likelihood thingie 
        #Should if the trial before the current one was an error-one as that means the current one is a meta-trial
        ##########################################################################################
