    ...
    for choice in range(n_choices): 
        ...
        if choice == 0: 
            ...
            if choice == 1: 
                ...
                error_1 = data.loc[choice + n_choices * simulation - 2 , "PE_1"] + 0.5 * (data.loc[choice + n_choices * simulation - 1 , "PE_1"] - data.loc[choice + n_choices * simulation - 2 , "PE_1"])
                error_2 = data.loc[choice + n_choices * simulation - 2 , "PE_2"] + 0.5 * (data.loc[choice + n_choices * simulation - 1 , "PE_2"] - data.loc[choice + n_choices * simulation - 2 , "PE_2"])
                error_3 = data.loc[choice + n_choices * simulation - 2 , "PE_3"] + 0.5 * (data.loc[choice + n_choices * simulation - 1 , "PE_3"] - data.loc[choice + n_choices * simulation - 2 , "PE_3"])
        ...
        if choice != 0: 
            ...
            error_1 = data.loc[choice + n_choices * simulation , "PE_1"] + 0 * (data.loc[choice + n_choices * simulation , "PE_1"] - data.loc[choice + n_choices * simulation - 1 , "PE_1"])
            error_2 = data.loc[choice + n_choices * simulation , "PE_2"] + 0 * (data.loc[choice + n_choices * simulation , "PE_2"] - data.loc[choice + n_choices * simulation - 1 , "PE_2"])
            error_3 = data.loc[choice + n_choices * simulation , "PE_3"] + 0 * (data.loc[choice + n_choices * simulation , "PE_3"] - data.loc[choice + n_choices * simulation - 1 , "PE_3"])
...
choice_order.to_csv('data/order_testing.csv')

np.save("data/model_loss_1" , history_1)
np.save("data/model_loss_2" , history_2)
np.save("data/model_loss_3" , history_3)

np.save("data/model_accuracy_1" , accuracy_1)
np.save("data/model_accuracy_2" , accuracy_2)
np.save("data/model_accuracy_3" , accuracy_3)
...
#Here I plot a rolling average of the softmax probability of selection per model 

softmax_choices = np.transpose(softmax_choices)

mean_10, lower_10, upper_10 = [],[],[]
mean_11, lower_11, upper_11 = [],[],[]
mean_12, lower_12, upper_12 = [],[],[]

for i in range(softmax_choices.shape[1]):
    
    print(i)
    
    a = softmax_choices[ : : 3 , i]
    ...
    Upper = MEAN+ci*std
    Lower = MEAN-ci*std
    lower_11.append(Lower)
    upper_11.append(Upper)
    
    a = softmax_choices[2 : : 3 , i]
    ...
    Upper = MEAN+ci*std
    Lower = MEAN-ci*std
    lower_12.append(Lower)
    upper_12.append(Upper)

def moving_average(x, w):
    return np.convolve(x, np.ones(w), 'valid') / w

mean_10 = moving_average(mean_10 , 50)
lower_10 = moving_average(lower_10 , 50)
upper_10 = moving_average(upper_10 , 50)

mean_11 = moving_average(mean_11 , 50)
lower_11 = moving_average(lower_11 , 50)
upper_11 = moving_average(upper_11 , 50)

mean_12 = moving_average(mean_12 , 50)
lower_12 = moving_average(lower_12 , 50)
upper_12 = moving_average(upper_12 , 50)

fig , ax = plt.subplots(2 , 2)

ax[0 , 0].plot(mean_10 , "-b" , label = "Model 1" , color = "green")
ax[0 , 0].fill_between(list(range(len(mean_10))), upper_10, lower_10, color="green", alpha=0.25)

ax[0 , 1].plot(mean_11 , "-b" , label = "Model 1" , color = "green")
ax[0 , 1].fill_between(list(range(len(mean_11))), upper_11, lower_11, color="green", alpha=0.25)

ax[1 , 0].plot(mean_12 , "-b" , label = "Model 1" , color = "green")
ax[1 , 0].fill_between(list(range(len(mean_12))), upper_12, lower_12, color="green", alpha=0.25)



ax[1 , 1].plot(mean_10 , "-b" , label = "Model 1" , color = "green")
ax[1 , 1].fill_between(list(range(len(mean_10))), upper_10, lower_10, color="green", alpha=0.25)
ax[1 , 1].plot(mean_11 , "-b" , label = "Model 1" , color = "red")
ax[1 , 1].fill_between(list(range(len(mean_11))), upper_11, lower_11, color="red", alpha=0.25)
ax[1 , 1].plot(mean_12 , "-b" , label = "Model 1" , color = "blue")
ax[1 , 1].fill_between(list(range(len(mean_12))), upper_12, lower_12, color="blue", alpha=0.25)
