...
#n_epochs    = 100
#n_trials    = 64 #this is the number of trials during an epoch, to keep it similar, go like this. This is the number of trials I include per epoch. Explicit here because I do a trial by trial selection. 
n_simulations  = 10
...
def run_model_1(simulation , model_1_index , opt): 
...
def run_model_2(simulation , model_2_index , opt): 
...
def run_model_3(simulation , model_3_index , opt): 
...
for simulation in range(n_simulations): 
    ...
    for choice in range(n_choices): 
        ...
        if current_model == 1: 
            ...
            model_prediction = run_model_1(simulation , model_1_index , opt_1)
            ...
            model_2_prediction = run_model_2(simulation , model_2_index , opt_2)
...
ax[0 , 1].plot(mean_3 , "-b" , label = "mean" , color = "red")
ax[0 , 1].fill_between(list(range(len(mean_3))), upper_3, lower_3, color="red", alpha=0.25)
