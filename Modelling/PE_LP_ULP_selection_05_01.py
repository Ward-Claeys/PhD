    ...
    for choice in range(n_choices): 
        ...
        if choice == 0: 
            ...
            if choice == 1: 
                ...
                model_1_value = np.exp(weight_PE * error_1 + weight_LP * LP_1 + weight_ULP * ULP_1) / (np.exp(weight_PE * error_1 + weight_LP * LP_1 + weight_ULP * ULP_1) + np.exp(weight_PE * error_2 + weight_LP * LP_2 + weight_ULP * ULP_2) + np.exp(weight_PE * error_3 + weight_LP * LP_3 + weight_ULP * ULP_3))
                model_2_value = np.exp(weight_PE * error_2 + weight_LP * LP_2 + weight_ULP * ULP_2) / (np.exp(weight_PE * error_1 + weight_LP * LP_1 + weight_ULP * ULP_1) + np.exp(weight_PE * error_2 + weight_LP * LP_2 + weight_ULP * ULP_2) + np.exp(weight_PE * error_3 + weight_LP * LP_3 + weight_ULP * ULP_3))
                model_3_value = np.exp(weight_PE * error_3 + weight_LP * LP_3 + weight_ULP * ULP_3) / (np.exp(weight_PE * error_1 + weight_LP * LP_1 + weight_ULP * ULP_1) + np.exp(weight_PE * error_2 + weight_LP * LP_2 + weight_ULP * ULP_2) + np.exp(weight_PE * error_3 + weight_LP * LP_3 + weight_ULP * ULP_3))
